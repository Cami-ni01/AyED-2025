...
public:
    ...
    // Ordena la lista in-place usando Bubble Sort.
    // Requiere que T defina operadores < y >.
    ...
    // Requiere T con < y > definidos.
    // asc = true -> orden ascendente; asc = false -> descendente.
